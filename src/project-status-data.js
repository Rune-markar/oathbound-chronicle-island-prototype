...
export const STATUS_ENTRIES = Object.freeze([
  ...
  entry({ id: "regional-travel", category: "implemented", area: "移動", title: "隣接地方・移動力制限付きの遠征", summary: "地形コストと残り移動力を共有APIで検証し、範囲外移動をUIと処理の両方で拒否する。", evidence: "地方移動は地図上の「進む」へ一本化され、所要時間と消費移動力の確認後だけ実行する。到達範囲API、世界時刻と月次回復にテストがある。", sources: [source("生成世界移動API", "./src/generated-world-system.js", "getGeneratedExpeditionReachableTiles / moveGeneratedExpeditionTo"), source("移動回帰テスト", "./tests/generated-world-system.test.mjs", "reachable movement"), source("Codex一次履歴", null, "thread 019feb05-7e37-7dd2-a18f-b792e46640b9", "history")] }),
